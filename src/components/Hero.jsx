    ...
    <section id="home" className="relative w-full min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full flex flex-col items-start gap-6 relative z-10">
        ...
        <motion.div 
          ...
          className="flex gap-6 mt-12 items-center text-gray-400"
        >
          <a href="https://www.linkedin.com/in/aliyas-babu-a62b97147/" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition-colors"><Linkedin size={24} /></a>
          <a href="mailto:aliyasbabu2@gmail.com" className="hover:text-cyan-400 transition-colors"><Mail size={24} /></a>
        </motion.div>
